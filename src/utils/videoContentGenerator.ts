// Enhanced video content generation with real software development videos
...
const generateTikTokVideoContent = (subject: string): SynchronizedVideoContent => {
  const segments: VideoSegment[] = [
    ...
    },
    {
      startTime: 10,
      endTime: 25,
      image: "https://images.unsplash.com/photo-1570194065650-d99bf9d4d665?w=800&h=600&fit=crop&q=80",
    ...
    },
    {
      startTime: 25,
      endTime: 40,
      image: "https://images.unsplash.com/photo-1562577309-2592ab84b1bc?w=800&h=600&fit=crop&q=80",
    ...
    },
    {
      startTime: 115,
      endTime: 120,
      image: "https://images.unsplash.com/photo-1556155092-490a1ba16284?w=800&h=600&fit=crop&q=80",
...
const generateWorkFromHomeVideoContent = (subject: string): SynchronizedVideoContent => {
  const segments: VideoSegment[] = [
    ...
    },
    {
      startTime: 30,
      endTime: 45,
      image: "https://images.unsplash.com/photo-1499951360447-b19be8fe80f5?w=800&h=600&fit=crop&q=80",
